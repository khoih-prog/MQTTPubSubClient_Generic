...
const char *PubMessage  = "Hello from WiFiMQTTSecure on " BOARD_NAME;      // Topic Message to publish

///////////////////////////////////////////////////////////////////////////////////////////////////////

// NOTES: You must save the Root CA or related Certs using WiFiNINA_Generic WiFiNINA Firmware Updater
...
void setup() 
{
  ...
  Serial.print(F("\nStart WiFiNINA_MQTTSecure on ")); Serial.println(BOARD_NAME);
