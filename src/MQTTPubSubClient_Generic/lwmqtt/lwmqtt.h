...
*/
#define lwmqtt_default_message      { LWMQTT_QOS0, false, NULL, 0 }
...
*/
#define lwmqtt_default_will     { lwmqtt_default_string, LWMQTT_QOS0, false, lwmqtt_default_string }
...
*/
#define lwmqtt_default_options      { lwmqtt_default_string, 60, true, lwmqtt_default_string, lwmqtt_default_string }
